...
<div class="wrapper">
    <div class="maincontent">
        <section class="section hero">
            <div class="container">
                <header class="header">
                    ...
                    <div class="header__links"><a class="order-link btn" href="#order-form">Заказать</a><a class="hamburger-menu-link" href="">
                        ...
                        <li class="burgers-slider__item">
                            ...
                            <div class="burgers-slider__right">
                                ...
                                <div class="burgers-slider__options">
                                    ...
                                    </div><a class="burgers-slider__buy btn" href="#order-form">Заказать</a>
                                </div>
                            </div>
                        </li>
                        <li class="burgers-slider__item">
        ...
        <section class="section order">
            <div class="container">
                <div class="section__title" id="order-form">Закажите доставку</div>
                <div class="order__form">
                    <form class="order__form-tag" action="/submit" method="POST">
                        <div class="order__form-col">
                            <div class="order__form-row order__form-row_double">
                                <label class="order__form-block">
                                    ...
                                    <input class="order__form-input" name="name" type="text" placeholder="" maxlength="60" required>
                                </label>
                                <label class="order__form-block">
                                    <div class="order__form-label">Телефон</div>
                                    <input class="order__form-input phone-mask" name="phone" type="text" placeholder="" maxlength="20" required>
                                </label>
                            </div>
                            <div class="order__form-row order__form-row_double">
                                <label class="order__form-block">
                                    <div class="order__form-label">email</div>
                                    <input class="order__form-input" name="email" type="email" placeholder="" maxlength="80" required>
                                </label>
                                <label class="order__form-block">
                                    <div class="order__form-label">Улица</div>
                                    <input class="order__form-input" name="street" type="text" placeholder="" maxlength="30" required>
                                </label>
                            </div>
                            <div class="order__form-row order__form-row_quatro">
                                <label class="order__form-block">
                                    <div class="order__form-label">Дом</div>
                                    <input class="order__form-input" name="home" type="text" placeholder="" maxlength="6" required>
                                </label>
                                <label class="order__form-block">
                                    <div class="order__form-label">Корпус</div>
                                    <input class="order__form-input" name="part" type="text" placeholder="" maxlength="4">
                                </label>
                                <label class="order__form-block">
                                    <div class="order__form-label">Квартира</div>
                                    <input class="order__form-input" name="appt" type="text" placeholder="" maxlength="6">
                                </label>
                                <label class="order__form-block">
                                    <div class="order__form-label">Этаж</div>
                                    <input class="order__form-input" name="floor" type="text" placeholder="4" maxlength="3">
                                </label>
                            </div>
                        </div>
                        <div class="order__form-col">
                            <div class="order__form-row">
                                <label class="order__form-block">
                                    ...
                                    <textarea class="order__form-input order__form-input_textarea" name="comment" maxlength="500"></textarea>
                                </label>
                            </div>
                            <div class="order__form-buttons">
                                ...
                                <div class="g-recaptcha" data-sitekey="6LfSTzoUAAAAAK3RTzAx80nlFNc0YitkUU1jQ7RW"></div>
                                <div class="order__form-row">
